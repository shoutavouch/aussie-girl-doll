...
const imageOverrides: Record<string, string> = {
  'dolls-classic-1': '/images/mira.png',
  'dolls-classic-2': '/images/Katherin.png',
  'dolls-classic-3': '/images/sophia.png',
  'dolls-classic-4': '/images/Lana.png',
  'dolls-classic-5': '/images/Lisa.png',
  'dolls-classic-6': '/images/Annie.png',
  'dolls-classic-7': '/images/Kira.png',
  'dolls-classic-8': '/images/Kim.png',
  'dolls-classic-9': '/images/Tara.png',
  'dolls-classic-10': '/images/Bella.png',
  'dolls-classic-11': '/images/Anna.png',
  'dolls-classic-12': '/images/Saira.png',
  'clothing-everyday-1': '/images/accessories/ballet%20dress.png',
  'clothing-everyday-2': '/images/accessories/Basket%20ball%20outfit.png',
  'clothing-everyday-3': '/images/accessories/overalls.png',
  'clothing-everyday-4': '/images/accessories/theater%20shirt.png',
  'clothing-party-1': '/images/accessories/birthday.png',
  'clothing-sleep-1': '/images/accessories/Pajamas%20and%20slipers.png',
  'clothing-sleep-2': '/images/accessories/pajamas.png',
  'clothing-seasonal-1': '/images/accessories/rain%20coat.png',
  'clothing-seasonal-2': '/images/accessories/Summer%20dress.png',
  'clothing-seasonal-3': '/images/accessories/swimsuit.png',
  'clothing-school-1': '/images/accessories/school%20uniform.png',
  'accessories-school-1': '/images/accessories/supplies.png',
  'accessories-school-2': '/images/accessories/lunch%20box.png',
  'accessories-school-3': '/images/accessories/bear%20backpack.png',
  'accessories-school-4': '/images/accessories/chair.png',
  'accessories-school-5': '/images/accessories/Heart%20backpack.png',
  'accessories-school-6': '/images/accessories/white%20bag.png',
  'accessories-little-dolls-1': '/images/accessories/ballet%20doll.png',
  'accessories-play-1': '/images/accessories/Lego.png',
  'accessories-instruments-1': '/images/accessories/Violin.png',
  'accessories-instruments-2': '/images/accessories/Piano.png',
  'accessories-pets-1': '/images/accessories/Kangaroo.png',
  'accessories-pets-2': '/images/accessories/Koala.png',
  'clothing-everyday-5': '/images/accessories/Tenis.png',
}
...
const clothingItems = [
  ...
  ...createSeries(
    ...
    'sleep',
    [
      'Cozy and Cute Pajamas',
      'Awesome Rainbow Pajamas',
      'Cloud Cozy Set',
      'Midnight Moon PJs',
...
const accessoryItems = [
  ...
  ...createSeries(
    ...
    [
      ...
      'Library Day Kit',
      'Field Trip Pack',
      'After School Study Set',
      'School Day Essentials',
      'Classroom Supplies Kit',
      'Creative Writing Pack',
      'Project Time Bundle',
    ],
    20,
    'School supplies:',
    'A school supplies accessory set designed for learning with',
  ),
  ...createSeries(
    'accessories',
    'little-dolls',
    [
      ...
      'Pocket Doll Friends',
      'Tiny Doll Trio',
      'Storytime Little Doll',
      'Travel Buddy Dolls',
      'Sleepover Little Dolls',
      'Playdate Mini Dolls',
      'Tiny Doll Adventures',
      'Collectible Little Dolls',
      'Rainbow Mini Dolls',
      'Best Friends Minis',
      'Picnic Little Dolls',
      'Dress-Up Mini Dolls',
      'Craft Time Little Dolls',
      'Garden Friends Minis',
      'Classroom Little Dolls',
      'Holiday Mini Dolls',
      'Adventure Minis',
      'Cozy Little Dolls',
    ],
    18,
    'Little dolls:',
    'A petite doll set designed for tiny adventures with',
  ),
  ...createSeries(
    'accessories',
    'instruments',
    ...
    22,
    'Instruments:',
    'A music accessory set designed for performances with',
  ),
  ...createSeries(
    'accessories',
    'pets',
    [
      'Fun and Playful Kangaroo',
      'Adorable Koala',
      'Puppy Park Pack',
      'Bunny Friend Kit',
      'Horse Care Set',
